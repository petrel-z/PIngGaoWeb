 ...
 * @property {CascaderOption[]} [children] - 子选项数组
 */

/**
 * @typedef {Object} AreaList
 * @property {Object.<string, string>} province_list - 省份列表
 * @property {Object.<string, string>} city_list - 城市列表
 * @property {Object.<string, string>} county_list - 县区列表
 */
 ...
 * @param {CascaderOption[]} [children] - 子选项数组
...
/**
 * 处理并构造级联选择所需的区域数据
 * @returns {CascaderOption[]} 含有省、市、县区嵌套结构的选项数组
 */
export function useCascaderAreaData() {
  const { province_list: province, city_list: city, county_list: county } = areaList;

  /** @type {Map<string, CascaderOption>} */
  ...
  Object.keys(county).forEach(code => {
    ...
    if (cityOption) {
      cityOption.children.push(makeOption(county[code], code));
    }
  });
